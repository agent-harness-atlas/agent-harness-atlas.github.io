...
| # | Agent | 综合 | 定级 | 证据来源 | 版本 |
|---|-------|:----:|:----:|----------|------|
| 1 | Gemini CLI | 85 | 卓越 | 源码 | v0.53.1 |
| 2 | Claude Code | 84 | 扎实 | 文档（闭源） | v2.1.220 |
| 3 | Codex CLI | 80 | 扎实 | 源码 | v0.146.0 |
| 4 | Cline | 73 | 扎实 | 源码 | v4.1.2 |
| 5 | opencode | 72 | 扎实 | 源码 | v1.18.11 |
| 6 | Pi | 72 | 扎实 | 源码 | v0.83.0 |
| 7 | Cursor Agent | 67 | 可用 | 文档（闭源） | v3.14 |
...
### Current standings (2026-W31)

| # | Agent | Overall | Band | Basis | Version |
|---|-------|:-------:|:----:|-------|---------|
| 1 | Gemini CLI | 85 | Exceptional | source | v0.53.1 |
| 2 | Claude Code | 84 | Strong | docs (closed) | v2.1.220 |
| 3 | Codex CLI | 80 | Strong | source | v0.146.0 |
| 4 | Cline | 73 | Strong | source | v4.1.2 |
| 5 | opencode | 72 | Strong | source | v1.18.11 |
| 6 | Pi | 72 | Strong | source | v0.83.0 |
| 7 | Cursor Agent | 67 | Functional | docs (closed) | v3.14 |
