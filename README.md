...
| # | Agent | 综合 | 定级 | 证据来源 | 版本 |
|---|-------|:----:|:----:|----------|------|
| 1 | Gemini CLI | 85 | 卓越 | 源码 | v0.52.0 |
| 2 | Claude Code | 84 | 扎实 | 文档（闭源） | v2.1.220 |
| 3 | Codex CLI | 80 | 扎实 | 源码 | v0.145.0 |
| 4 | Cline | 73 | 扎实 | 源码 | v4.0.11 |
| 5 | opencode | 72 | 扎实 | 源码 | v1.18.5 |
| 6 | Pi | 72 | 扎实 | 源码 | v0.82.1 |
| 7 | Cursor Agent | 67 | 可用 | 文档（闭源） | v3.13 |
...
### Current standings (2026-W30)

| # | Agent | Overall | Band | Basis | Version |
|---|-------|:-------:|:----:|-------|---------|
| 1 | Gemini CLI | 85 | Exceptional | source | v0.52.0 |
| 2 | Claude Code | 84 | Strong | docs (closed) | v2.1.220 |
| 3 | Codex CLI | 80 | Strong | source | v0.145.0 |
| 4 | Cline | 73 | Strong | source | v4.0.11 |
| 5 | opencode | 72 | Strong | source | v1.18.5 |
| 6 | Pi | 72 | Strong | source | v0.82.1 |
| 7 | Cursor Agent | 67 | Functional | docs (closed) | v3.13 |
