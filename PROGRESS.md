...
## Session 2026-07-25T21:08:00Z
Weekly refresh 2026-W30. Version bumps only (scores held, all citations verify clean vs HEAD, 0 problems):
codex v0.144.5→v0.145.0, pi v0.80.10→v0.82.1, opencode v1.18.3→v1.18.5, gemini-cli v0.51.0→v0.52.0,
cline v4.0.9→v4.0.11, claude-code v2.1.214→v2.1.220, cursor v3.11→v3.13. aider unchanged (v0.86.0).
